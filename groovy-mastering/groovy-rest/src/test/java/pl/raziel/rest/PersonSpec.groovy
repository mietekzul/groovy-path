...
class PersonSpec extends Specification {
    ...
    def 'add to set to verity equals and hashcode'() {
    ...
    def 'transform person into json'() {
        ...
        Person p = new Person(first: 'Jonathan', last: 'Archer')

        expect: 'convert person to JSON'
        p.toJson() == [id: null, first: 'Jonathan', last: 'Archer']
    }

    def 'transform person into XML'() {
        given: 'a person with a first and last name'
        Person p = new Person(id: 99, first: 'Jonathan', last: 'Archer')
